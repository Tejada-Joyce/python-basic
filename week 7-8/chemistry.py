...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        return known_molecules_dict[formula].capitalize()
    else:
...
def make_periodic_table():
    ...
    Parameters: none
    Returns: a compound list that contains the elements of the
            periodic table
    """
    table = {
