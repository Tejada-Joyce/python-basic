...
"""
Add exception handling code that prints a useful error message when the computer raises FileNotFoundError or PermissionError.
Add exception handling code that prints a useful error message when the computer raises ValueError while it is converting the percentage entered by the user to a float.
...
def main():
    ...
    # Add exception handling code that prints a useful error message 
    # when the computer raises FileNotFoundError or PermissionError.
        ...
        print(perm_err)
        print("Please choose a different file.")   
    # Add exception handling code that prints a useful error message when 
    # the computer raises ValueError while it is converting the percentage 
    # entered by the user to a float.
    except ValueError as val_err:
        print(f"Error: {val_err}")

    # except ZeroDivisionError as zero_div_err:
    #     print(f"Error: {zero_div_err} on line {reader.line_num} in {filename}.")
